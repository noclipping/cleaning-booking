        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-gray-900">CleanPro Services</h1>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Regular Cleaning</h3>
              <p className="text-gray-600 mb-4">Standard cleaning service for regular maintenance</p>
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">Thorough cleaning including hard-to-reach areas</p>
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">Comprehensive cleaning for moving situations</p>
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">Specialized cleaning after construction work</p>
